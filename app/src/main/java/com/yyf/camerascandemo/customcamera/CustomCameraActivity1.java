...
public class CustomCameraActivity1 extends Activity implements View.OnClickListener {
    ...
    private final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            CustomCameraActivity1.this.cameraDevice = cameraDevice;
            // 开始预览
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            cameraDevice.close();
            CustomCameraActivity1.this.cameraDevice = null;
        }
        ...
        public void onError(CameraDevice cameraDevice, int error) {
            cameraDevice.close();
            CustomCameraActivity1.this.cameraDevice = null;
            CustomCameraActivity1.this.finish();
        }
    };
    ...
    private void createCameraPreviewSession()
    {
        try
        {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(new Surface(texture), imageReader.getSurface()), new CameraCaptureSession.StateCallback() // ③
                    {
                        @Override
                        ...
                        {
                            Toast.makeText(CustomCameraActivity1.this, "配置失败！"
            ...
            imageReader.setOnImageAvailableListener(
                    new ImageReader.OnImageAvailableListener()
                    {
                        ...
                        public void onImageAvailable(ImageReader reader)
                        {
                            ...
                            {
                                output.write(bytes);
                                Toast.makeText(CustomCameraActivity1.this, "保存: "
